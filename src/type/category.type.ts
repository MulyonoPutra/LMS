...
export type CategoryResponseType = TypedResponse<
	ResponseMessage | Partial<ResponseEntity<Category[]>>
>;
export type FindOneCategoryResponseType = TypedResponse<
	ResponseMessage | Partial<ResponseEntity<Category | null>>
>;
export type CategoryRequestType = TypedRequest<Record<string, never>, Category>;
export type RemoveCategoryResponseType = TypedResponse<
